...
from common.services.warehouse_service import load_head_to_head_silver_to_raw
...
with DAG(
    dag_id="silver_to_postgres_head_to_head",
    ...
    tags=["warehouse", "load", "head_to_head"],
) as dag:
    PythonOperator(
        task_id="load_head_to_head_silver_to_postgres",
        python_callable=load_head_to_head_silver_to_raw,
