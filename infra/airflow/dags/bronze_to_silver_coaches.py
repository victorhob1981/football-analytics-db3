...
from common.services.mapping_service import map_coaches_raw_to_silver
...
with DAG(
    dag_id="bronze_to_silver_coaches",
    ...
    tags=["silver", "coaches", "identity"],
) as dag:
    PythonOperator(
        task_id="bronze_to_silver_coaches_latest_per_id",
        python_callable=map_coaches_raw_to_silver,
