...
from common.services.warehouse_service import load_standings_silver_to_raw
...
with DAG(
    dag_id="silver_to_postgres_standings",
    ...
    tags=["warehouse", "load", "standings"],
) as dag:
    PythonOperator(
        task_id="load_standings_silver_to_postgres",
        python_callable=load_standings_silver_to_raw,
