...
from common.services.warehouse_service import load_team_coaches_silver_to_raw
...
with DAG(
    dag_id="silver_to_postgres_team_coaches",
    ...
    tags=["warehouse", "load", "coaches"],
) as dag:
    PythonOperator(
        task_id="load_team_coaches_silver_to_postgres",
        python_callable=load_team_coaches_silver_to_raw,
