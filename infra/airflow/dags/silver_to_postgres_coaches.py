...
from common.services.warehouse_service import load_coaches_silver_to_raw
...
with DAG(
    dag_id="silver_to_postgres_coaches",
    ...
    tags=["warehouse", "load", "coaches", "identity"],
) as dag:
    PythonOperator(
        task_id="load_coaches_silver_to_postgres",
        python_callable=load_coaches_silver_to_raw,
