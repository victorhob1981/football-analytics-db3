...
from common.services.warehouse_service import load_lineups_silver_to_raw
...
with DAG(
    dag_id="silver_to_postgres_lineups",
    ...
    tags=["warehouse", "load", "lineups"],
) as dag:
    PythonOperator(
        task_id="load_lineups_silver_to_postgres",
        python_callable=load_lineups_silver_to_raw,
