...
from common.services.mapping_service import map_player_transfers_raw_to_silver
...
with DAG(
    dag_id="bronze_to_silver_player_transfers",
    ...
    PythonOperator(
        task_id="bronze_to_silver_player_transfers_latest_per_player",
        python_callable=map_player_transfers_raw_to_silver,
