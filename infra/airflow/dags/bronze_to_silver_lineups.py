...
from common.services.mapping_service import map_fixture_lineups_raw_to_silver
...
with DAG(
    dag_id="bronze_to_silver_lineups",
    ...
    PythonOperator(
        task_id="bronze_to_silver_lineups_latest_per_fixture",
        python_callable=map_fixture_lineups_raw_to_silver,
