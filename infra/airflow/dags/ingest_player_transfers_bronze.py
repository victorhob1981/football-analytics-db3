...
from common.services.ingestion_service import ingest_player_transfers_raw
...
with DAG(
    dag_id="ingest_player_transfers_bronze",
    ...
    PythonOperator(
        task_id="ingest_player_transfers",
        python_callable=ingest_player_transfers_raw,
