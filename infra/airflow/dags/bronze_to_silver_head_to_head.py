...
from common.services.mapping_service import map_head_to_head_raw_to_silver
...
with DAG(
    dag_id="bronze_to_silver_head_to_head",
    ...
    tags=["silver", "head_to_head"],
) as dag:
    PythonOperator(
        task_id="bronze_to_silver_head_to_head_latest_per_pair",
        python_callable=map_head_to_head_raw_to_silver,
