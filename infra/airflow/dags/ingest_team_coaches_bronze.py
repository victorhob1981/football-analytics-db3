...
from common.services.ingestion_service import ingest_team_coaches_raw
...
with DAG(
    dag_id="ingest_team_coaches_bronze",
    ...
    PythonOperator(
        task_id="ingest_team_coaches",
        python_callable=ingest_team_coaches_raw,
