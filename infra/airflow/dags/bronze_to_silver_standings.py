...
from common.services.mapping_service import map_standings_raw_to_silver
...
with DAG(
    dag_id="bronze_to_silver_standings",
    ...
    tags=["silver", "standings"],
) as dag:
    PythonOperator(
        task_id="bronze_to_silver_standings",
        python_callable=map_standings_raw_to_silver,
