...
from common.services.ingestion_service import ingest_player_season_statistics_raw
...
with DAG(
    dag_id="ingest_player_season_statistics_bronze",
    ...
    tags=["bronze", "player_stats", "season"],
) as dag:
    PythonOperator(
        task_id="ingest_player_season_statistics",
        python_callable=ingest_player_season_statistics_raw,
